...
public class PDataComponentRegistry {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<SelectedBranchOptions>> SELECTED_BRANCH = DATA_COMPONENTS.register("selected_branch",
            () -> DataComponentType.<SelectedBranchOptions>builder().persistent(SelectedBranchOptions.CODEC).build());
